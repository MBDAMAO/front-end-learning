  ...
  <div class="videoContainer">
    ...
    <div class="vbox">
      <div class="expand" @click="showSide()" v-show="!showside">
        <svg t="1707052181872" class="icon" viewBox="0 0 1028 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="20169" fill="rgba(169, 169, 169, 0.8)">
          <path
      ...
      <div class="topPlay" @click="change()" v-show="!playing">
        <svg t="1705315469945" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="5315" width="70" height="70">
          <path
            d="M128 138.666667c0-47.232 33.322667-66.666667 74.176-43.562667l663.146667 374.954667c40.96 23.168 40.853333 60.8 0 83.882666L202.176 928.896C161.216 952.064 128 932.565333 128 885.333333v-746.666666z"
            fill="#fff" p-id="5316"></path>
        </svg>
      </div>
      <div class="details">
        <div class="account">
      ...
      <div class="sideBar">
        <div class="headimg">
          ...
          <svg t="1706801829143" class="follow" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <path
              ...
              p-id="11088" fill="#FE2C55"></path>
          </svg>
        </div>
        <div class="like" v-on:click="like()">
          <svg t="1706800852085" class="icon1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="5248" ref="likeButton" :fill="likecolor">
            <path
        ...
        <div class="comment" v-on:click="openComment()">
          <svg t="1706801099641" class="icon1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="15649">
            <path
        ...
        <div class="more" v-on:click="openMoreSide()">
          <svg t="1706801332358" class="icon1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="28640">
            <path d="M0 0m0 0l1024 0q0 0 0 0l0 1024q0 0 0 0l-1024 0q0 0 0 0l0-1024q0 0 0 0Z" fill="#ffffff"
              fill-opacity="0" p-id="28641"></path>
            <path
              ...
              fill="#ffffff" p-id="28642"></path>
          </svg>
          <div class="numinfo">看相关</div>
        </div>
        <div class="other">
          <svg t="1706801395970" class="icon1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="29834">
            <path
          ...
          <div class="controlItems">
            <div class="left">
              <div class="playButton" v-on:click="change()">
                <svg t="1705315469945" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="5315" v-show="!playing">
                  <path
                    d="M128 138.666667c0-47.232 33.322667-66.666667 74.176-43.562667l663.146667 374.954667c40.96 23.168 40.853333 60.8 0 83.882666L202.176 928.896C161.216 952.064 128 932.565333 128 885.333333v-746.666666z"
                    fill="#fff" p-id="5316"></path>
                </svg>
                <svg t="1706784841703" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="4210" v-show="playing">
                  <path
