<template>
  <div class="videoSide">
    ...
    <div class="headnavi">
      ...
      <div class="exit">
        <svg t="1707051708736" class="exits" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="6786" fill="rgba(169, 169, 169, 0.8)" @click="$emit('closeEvent')">
          <path
